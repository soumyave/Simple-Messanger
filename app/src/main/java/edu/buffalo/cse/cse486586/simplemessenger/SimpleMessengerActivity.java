        ...
        editText.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                     ...
                     * http://developer.android.com/reference/android/os/AsyncTask.html
                     */
                    Log.e(TAG,"Checking Client Task side");
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try
            {
                while(true)
                {
                    ...
                    DataInputStream clientmessage = new DataInputStream(clientSocket.getInputStream());
                    String messagereceivedfromclient = clientmessage.readLine();
                    if(messagereceivedfromclient != null)
                    {
                        if (servermessage != null) {
                            servermessage.writeBytes("ACCEPTED");
                        }
                        publishProgress(messagereceivedfromclient);
                    }
                    else {
                        continue;
                    }
        ...
        protected Void doInBackground(String... msgs) {
            try {
                 ...
                 */
                    ...
                    {
                        clientmessage.writeBytes(msgToSend);
                    }
                    DataInputStream servermessage = new DataInputStream(socket.getInputStream());
                    String messagereceivedfromserver = servermessage.readLine();
                    if (messagereceivedfromserver.equals("ACCEPTED")) {
                        Log.e(TAG, "message has been accepted by server");
                    }
